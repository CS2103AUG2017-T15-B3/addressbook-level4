...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier").withPhone("98765432")
    ...
    public static final ReadOnlyPerson HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withHomeNumber("67228190").withEmail("stefan@example.com").withAddress("little india").build();
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withHomeNumber("65478931").withEmail("hans@example.com").withAddress("chicago ave").build();
