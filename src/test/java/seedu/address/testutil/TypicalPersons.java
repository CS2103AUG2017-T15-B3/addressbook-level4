...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder()
            ...
            .withPhone("85355255").withWebsite("https://www.facebook.com/alice")
    ...
    public static final ReadOnlyPerson BOB = new PersonBuilder()
            ...
            .withWebsite(VALID_WEBSITE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
