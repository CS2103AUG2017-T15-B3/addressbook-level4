...
public class EditCommand extends UndoableCommand {
    ...
    private static Person createEditedPerson(ReadOnlyPerson personToEdit,
        ...
        return new Person(updatedName, updatedPhone, updatedHomeNumber, updatedEmail, updatedAddress, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(this.name, this.phone,
                    this.homeNumber, this.email, this.address, this.tags);
        }
